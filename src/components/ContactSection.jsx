...
const contactChannels= [
    {
        ...
        action: "Get Directions",
        href: "https://maps.google.com/?q=Beans+Place+Strasburg+CO%22"
    },
    {
        name: "Opening Hours",
        icon:(
...
// TiltCard
// Wrapper that tilts its contents in 3D towards the mouse. Local to this file
...
function TiltCard({children, className, href, target, rel}){
    ...
    // resets on leave so the card springs back flat
