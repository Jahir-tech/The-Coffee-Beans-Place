...
const products =[
    ...
    },
    {
        ...
        price: "$21.99",
        roast: "Light",
        notes: "Bright citrus, black current, floral",
        image: imgKenyaAA,
        badge: "Staff Pick"
    },
    {
    ...
    },
    {
        ...
        price: "$17.99",
        roast: "Dark",
        notes: "Cocoa, spice, smokey sweetness",
...
export default function ProductShowcase(){
    return (
        <div className="product-showcase">
            {/* Header - rising delays buid it top-to-bottom */}
                ...
                {products.map((product) => (
                    ...
                    <StaggerItem key={product.name} animation="fadeUp">
                        <motion.div
                            ...
                            whileHover={{y: -8, transtition: {duration: 0.25}}}
                        >
                            <div className = "product-card-image">
